  ...
  aboutPageParagraphs: [
    {
      ...
      en: "Pozitiv Films s.r.o. was founded in 2023 with the goal of creating a new platform for high-quality, auteur-driven TV productions. Its first project, Náhradníci (The Substitutes), by prolific screenwriter Alice Nellis, was released on the VOD service Prima+ in 2024 and won the International Jury Award for the Best TV Project at the 2025 Finále Plzeň festival. The series was co-directed by Jiří Havelka, who had the opportunity to develop his project, Kulturák (The Community Hall), at Pozitiv Films (development finished in 2025). As its second project, Pozitiv Films finished the sixteen-episode crime series Mladá Krev (Young Blood), which became the most-watched Saturday prime-time TV program on FTV Prima for most of the 2025 autumn season. Pozitiv Films is currently developing its second season while starting the production of the 8-part limited thriller series Marika, by Alice Nellis (production 2026-2027). ",
    },
    {
      cs: "V současnosti připravuje Pozitiv Films pro FTV Prima jeho druhou řadu a od září 2026 začíná natáčení osmidílného dramatu Marika (scénář Alice Nellis, režie Alice Nellis, Michal Blaško), podpořeného výrobním grantem SFA. ",
      en: "",
    },
  ],
